...
import "./globals.css";
import { ChatButton } from '@/widgets/Chat/ChatButton';
...
export const metadata: Metadata = {
  ...
  description:
    "Профессиональный Frontend разработчик с опытом создания современных веб-приложений. Специализируюсь на React, TypeScript и Next.js",
  keywords: [
    "Frontend Developer",
    "React Developer",
    "TypeScript",
  ...
  openGraph: {
    ...
    description:
      "Профессиональный Frontend разработчик. Создаю современные веб-приложения используя React, TypeScript и Next.js",
    images: [
      {
